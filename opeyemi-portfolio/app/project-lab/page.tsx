...
import { Suspense, useMemo, useState, useEffect, lazy, useTransition } from "react"
...
import { Maximize2, Minimize2, Pause, Play, ChevronLeft, ChevronRight, ExternalLink, Github, Gamepad2 } from "lucide-react"
...
const LazyParticlesBg = lazy(() => import("@/components/particles-bg").then(m => ({ default: m.ParticlesBg })))
...
function ProjectLabContent() {
  ...
  useEffect(() => {
    ...
    // Load database projects in the background
    ...
    // Show base projects immediately, load DB projects in background
    setIsLoadingProjects(false)
    loadProjects()
  ...
  return (
    <>
      <section className="w-full py-20">
        ...
        <div className="mb-16 text-center opacity-0 animate-[fadeIn_0.7s_ease-out_forwards]">
        ...
        <div className="mb-12 flex flex-col items-center opacity-0 animate-[fadeIn_0.5s_ease-out_0.2s_forwards]">
              ...
              <div className="grid gap-8 lg:grid-cols-[1.5fr_1fr] h-full overflow-y-auto p-6">
                <div className="space-y-6 h-full flex flex-col overflow-y-auto pr-2">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="relative w-full overflow-hidden rounded-lg border border-gray-700 bg-gray-800/50 game-container" style={{ paddingBottom: '56.25%', height: 0 }}>
                    ...
                    <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {filteredProjects[active].tags?.map((tag, index) => (
                          <div key={tag} className="transition-transform hover:scale-105">
                            <Badge 
                  ...
                  <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {filteredProjects[active].aiTools?.map((tool, index) => (
                        <div key={tool} className="transition-transform hover:scale-105">
                          <Badge 
                    ...
                    <div className="flex flex-wrap gap-3">
                      {filteredProjects[active].links?.demo && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="group relative flex-1 min-w-[160px] px-6 py-3 text-sm font-medium text-center rounded-lg overflow-hidden transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_10px_25px_-5px_rgba(236,72,153,0.4)]"
                          style={{
                      ...
                      {filteredProjects[active].links?.repo && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="group relative flex-1 min-w-[160px] px-6 py-3 text-sm font-medium text-center bg-gray-800/50 border border-gray-700 rounded-lg overflow-hidden transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_10px_25px_-5px_rgba(6,182,212,0.2)]"
                        >
