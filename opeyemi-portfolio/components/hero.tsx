  ...
  return (
    <div className="relative z-10">
      <div
        ...
        aria-hidden
      />
      <div className="container mx-auto grid min-h-[70vh] grid-cols-1 items-center gap-10 px-4 py-20 md:grid-cols-2">
        <motion.div style={{ y }} className="space-y-6">
          ...
          >
            {
              "I help clients like you turn ideas into polished games, software, and tools, combining beautiful design, engaging interactions, and robust engineering. I use AI to speed up prototyping, create assets, and automate repetitive work, delivering production-ready experiences faster."
            }
          </motion.p>
          <motion.div
          ...
          >
            <a href="https://www.upwork.com/freelancers/~010cb1dc112cd4f0fb?mp_source=share" target="_blank" rel="noopener noreferrer">
              <Button className="group bg-fuchsia-600 hover:bg-fuchsia-500 shadow-[0_0_30px] shadow-fuchsia-600/40">
            ...
            <a href="#projects">
              <Button variant="outline" className="border-fuchsia-500/30 bg-white/5 hover:bg-white/10">
                View Projects
              </Button>
            </a>
          </motion.div>
          <motion.div
            style={{ opacity: glow }}
            className="pointer-events-none mt-6 h-12 w-12 rounded-full bg-fuchsia-500/20 blur-2xl"
          />
        </motion.div>
